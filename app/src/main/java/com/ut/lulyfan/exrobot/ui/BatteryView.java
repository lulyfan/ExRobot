...
public class BatteryView extends View{
	...
	protected void onDraw(Canvas canvas) {
		...
		System.out.println("vallen battery ondraw");

		int battery_left = 0;
		int battery_top = 0;
		int battery_width = 125;
		int battery_height = 50;
		
		int battery_head_width = 15;
		int battery_head_height = 15;
		...
		System.out.println("vallen draw text");


		canvas.drawText(mPower+"%",45,30,paint3);
	}
