...
public class KeyboardView extends LinearLayout implements View.OnClickListener {
    ...
    private void initKeyboardButtons(KeyboardView view) {
        ...
        mButtons.add((KeyboardButtonView) view.findViewById(R.id.pin_code_button_sure));
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.pin_code_button_sure) {
            mKeyboardButtonClickedListener.onKeyboardClick(KeyboardButtonEnum.BUTTON_SURE);
        }
    }
